...
{
    class NV_STT_Item_New_StoreTransfer : Documents.DCM_Items.DCM_Item_New.View.NV_DCM_Item_New_Main
    {
        public NV_STT_Item_New_StoreTransfer()
        {
            BT_Summary.Visibility = Visibility.Hidden;
        }
