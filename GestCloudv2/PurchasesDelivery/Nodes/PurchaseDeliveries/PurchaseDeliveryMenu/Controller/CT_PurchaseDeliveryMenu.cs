...
namespace GestCloudv2.PurchasesDelivery.Nodes.PurchaseDeliveries.PurchaseDeliveryMenu.Controller
{
        ...
        private void ChangeController()
        {
            switch (Information["controller"])
            {
                case 0:
                    ...
                    a.MainFrame.Content = new PurchasesDelivery.Controller.CT_PurchasesDelivery();
                    break;
